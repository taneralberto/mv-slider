        ...
        ?>
                <li>
                    ...
                    if( has_post_thumbnail() ) {
                        ...
                        echo "<img src='". MV_SLIDER_URL ."assets/images/default.jpg' class='wp-post-image img-fluid' />";
                    }
                    ?>
                        ...
                        <div class="slider-details-container">
                            <div class="wrapper">
                                ...
                                <div class="slider-description">
                                    ...
                                    <a href="#" class="<?php echo esc_url( $button_url ); ?>"><?php echo esc_html( $button_text ); ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
